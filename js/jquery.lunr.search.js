  ...
  var LunrSearch = (function() {
    ...
    LunrSearch.prototype.createIndex = function() {
      return lunr(function() {
        ...
        // this.field('tags');
        // this.ref('id');
        //This removes the stemmer from lunr to avoid issue with certain character lengths not returning any results, described here: https://github.com/olivernn/lunr.js/issues/38
    ...
    LunrSearch.prototype.displayResults = function(entries) {
      ...
      if (entries.length === 0) {
        $entries.append('<p>Sorry, nothing found. Please try again.</p>')
      } else {
